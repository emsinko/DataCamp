...
####### 
## k malé --> prisposobuje sa hranicna ciara,  k velke ---> podoba saa na priamkove rozhranie 
...
#     Problem je taky, ze ak mame nejaku premennu, ktora má 0 eventov (byt v práci cez víkend) tak automaticky sa pri nasobeni 0 dostane 0-pravdepodobnost
